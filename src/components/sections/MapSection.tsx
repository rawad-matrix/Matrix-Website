...
export function MapSection() {
  return (
    <section className="bg-white overflow-hidden" style={{ height: 'calc(100vh - 72px)', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      <div className="max-w-[1280px] mx-auto px-8 max-[640px]:px-5 pt-10 pb-4">
        <SectionHeader
          label="Find Us"
      ...
      <div className="w-full overflow-hidden" style={{ flex: 1, minHeight: '380px' }}>
        <iframe
