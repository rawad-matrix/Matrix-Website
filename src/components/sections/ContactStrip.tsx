...
export function ContactStrip() {
  return (
    ...
    >
      <div className="max-w-[1280px] mx-auto px-8 max-[640px]:px-5 flex justify-between items-center gap-8 flex-wrap">
        <div>
          <h3
        ...
        <div className="flex gap-3 flex-wrap">
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-[#2A2F3A] text-white px-5 py-3 font-dm font-semibold text-[12.5px] uppercase tracking-[0.04em] rounded-[2px] hover:bg-black hover:-translate-y-px transition-all duration-150"
          >
            Contact Us
          </Link>
          <a
            ...
            className="inline-flex items-center gap-2 bg-[#25D366] text-white px-5 py-3 font-dm font-semibold text-[12.5px] uppercase tracking-[0.04em] rounded-[2px] hover:brightness-110 hover:-translate-y-px transition-all duration-150"
          >
