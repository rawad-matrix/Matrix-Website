export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed right-6 bottom-6 z-[60] w-[54px] h-[54px] bg-[#25D366] rounded-full grid place-items-center text-white hover:scale-110 transition-transform duration-200"
      style={{ boxShadow: '0 10px 30px rgba(37,211,102,.35)' }}
    >
