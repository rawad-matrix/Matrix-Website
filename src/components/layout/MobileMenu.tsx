...
const NAV_LINKS: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: '/courses?brand=SCADA',            label: 'SCADA' },
      { href: '/courses?brand=Siemens',          label: 'Siemens' },
      { href: '/courses?brand=Delta',            label: 'Delta' },
      { href: '/courses?brand=Classic%20Control', label: 'Classic Control' },
      { href: '/courses?brand=IoT',              label: 'IoT' },
      { href: '/courses?brand=Other',            label: 'Other' },
    ],
  },
