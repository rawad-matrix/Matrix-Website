// Country dial codes for the registration phone field.
// NOTE: Israel (IL / +972) is intentionally omitted.
// Default selection is Lebanon (+961).

export type Country = { name: string; iso: string; dial: string }

export const DEFAULT_DIAL = '+961' // Lebanon

// Derive the flag emoji from the ISO-3166 alpha-2 code (regional indicators),
// so we don't have to hand-maintain 190+ emoji.
...
// Alphabetical by country name. Comprehensive UN-member list (Israel excluded).
