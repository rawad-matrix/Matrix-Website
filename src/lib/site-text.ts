...
export const SITE_TEXT_PAGES: TextPage[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { key: 'training.track2.title', label: 'Track 2 — title', def: 'On-the-Job Training' },
  ...
  {
    page: 'Training — On-the-Job',
    sections: [
      {
        section: 'Hero',
        blocks: [
          { key: 'tjob.hero.title1', label: 'Title — first word(s)', def: 'On-the-Job' },
