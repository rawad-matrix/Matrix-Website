    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { key: 'si.epc.p.title', label: 'P card — title', def: 'Industrial Automation Supply' },
          { key: 'si.epc.p.desc', label: 'P card — description', multiline: true, def: "Supplying industrial automation equipment from globally recognised manufacturers, backed by expert technical consultation, product sizing, procurement, and end-to-end logistics." },
          { key: 'si.epc.p.item1', label: 'P card — bullet 1', def: 'Products from leading global automation brands' },
          { key: 'si.epc.p.item2', label: 'P card — bullet 2', def: 'Technical consultation and application sizing' },
          { key: 'si.epc.p.item3', label: 'P card — bullet 3', def: 'Procurement and supply management' },
          { key: 'si.epc.p.item4', label: 'P card — bullet 4', def: 'International shipping, import logistics & customs' },
